...
class CategoriesModel {
    ...
    static async getCaterogiesV1Bycategories_id(id) {
        return await executeQuery("SELECT * FROM CategoriesV1 where categories_id=?;", [id]);
    }
    static async getCaterogiesV2Bycategories_id(id) {
        return await executeQuery("SELECT * FROM CategoriesV2 where categoriesV1_id=?;", [id]);
    }
    ...
    static async createCaterogiesv1(name,categories_id ) {
        return await executeQuery(`INSERT INTO Categoriesv1 (name, categories_id) VALUES (?, ?);`, [name, categories_id]);
    }
    static async createCaterogiesv2(name, categoriesV1_id) {
        return await executeQuery(`INSERT INTO Categoriesv2 (name, categoriesV1_id) VALUES (?, ?);`, [name, categoriesV1_id]);
    }
